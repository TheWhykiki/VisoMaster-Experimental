...
IF EXIST ".venv\Scripts\python.exe" (
    ...
    IF DEFINED CONDA_BAT (
        ...
        IF NOT "!EXIT_CODE!"=="0" goto :HandleError
        echo Running VisoMaster with conda environment "%ENV_NAME%"...
        call "%CONDA_BAT%" run -n "%ENV_NAME%" python main.py
        set "EXIT_CODE=!ERRORLEVEL!"
        goto :AfterRun
    )
    ...
    IF DEFINED ENV_PYTHON (
        echo Conda launcher not found, launching with detected visomaster environment...
