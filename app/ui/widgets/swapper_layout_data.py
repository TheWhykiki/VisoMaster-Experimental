...
SWAPPER_LAYOUT_DATA: LayoutDictTypes = {
    "Swapper": {
        ...
        "FluxModelSelection": {
            ...
            "options": lambda manager: manager.get_selection_values(),
            "default": lambda manager: manager.get_default_value(),
            "optionsManager": "flux_model_manager",
            "parentSelection": "SwapModelSelection",
            "requiredSelectionValue": FLUX_SWAPPER_MODEL_NAME,
            "help": "Select a local FLUX base model or use the built-in auto-download entry for the ACE++ swapper.",
        },
        "FluxLoraSelection": {
            "level": 2,
            "label": "ACE++ / LoRA",
            "options": lambda manager: manager.get_selection_values(),
            "default": lambda manager: manager.get_default_value(),
            "optionsManager": "flux_lora_manager",
            "parentSelection": "SwapModelSelection",
            "requiredSelectionValue": FLUX_SWAPPER_MODEL_NAME,
            "help": "Select an ACE++ / compatible FLUX LoRA or use one of the built-in auto-download presets.",
        },
        "FluxSettingsEnableToggle": {
            "level": 2,
            "label": "Show FLUX Settings",
            "default": False,
            "parentSelection": "SwapModelSelection",
            "requiredSelectionValue": FLUX_SWAPPER_MODEL_NAME,
            "help": "Show the advanced FLUX and mask settings used by the ACE++ swapper.",
        },
        "FluxPromptText": {
            "level": 3,
            "label": "Prompt",
            ...
            "help": "Prompt used internally by the ACE++ (FLUX) swapper.",
        },
        "FluxNegativePromptText": {
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Negative prompt for the ACE++ (FLUX) swapper.",
        },
        "FluxStepsSlider": {
            "level": 3,
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Number of inference steps for FLUX.",
        },
        "FluxGuidanceDecimalSlider": {
            "level": 3,
            "label": "Guidance",
            "min_value": "0.0",
            "max_value": "10.0",
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Guidance scale for FLUX inference.",
        },
        "FluxTrueCFGDecimalSlider": {
            "level": 3,
            "label": "True CFG",
            "min_value": "0.0",
            "max_value": "5.0",
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "True CFG scale for Kontext/Inpaint pipelines.",
        },
        "FluxLoRAStrengthDecimalSlider": {
            "level": 3,
            "label": "LoRA Strength",
            "min_value": "0.0",
            "max_value": "2.0",
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Blend strength for the selected FLUX LoRA.",
        },
        "FluxSeedSlider": {
            "level": 3,
            "label": "Seed",
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Set to 0 for a random seed.",
        },
        ...
        "FluxCPUOffloadToggle": {
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Enable model CPU offload to reduce VRAM usage for FLUX.",
        },
        "FluxDebugMaskToggle": {
            "level": 3,
            "label": "Debug Face Mask",
            "default": False,
            "parentSelection": "SwapModelSelection",
            "requiredSelectionValue": FLUX_SWAPPER_MODEL_NAME,
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Skip FLUX inference and show the current ACE++ face mask as an overlay for debugging.",
        },
        "FluxCropScaleDecimalSlider": {
            "level": 3,
            "label": "Target Crop Scale",
            "min_value": "1.4",
            "max_value": "2.8",
            "default": "1.85",
            "step": 0.05,
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Controls how much head area the FLUX target crop includes around the face.",
        },
        "FluxCropVYRatioDecimalSlider": {
            "level": 3,
            "label": "Target Crop VY",
            "min_value": "-0.25",
            "max_value": "0.00",
            "default": "-0.15",
            "step": 0.01,
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Shifts the FLUX target crop vertically to include more forehead and head area.",
        },
        "FluxMaskProviderSelection": {
            "level": 3,
            "label": "Mask Provider",
            "options": ["Face Parser (Full Face)"],
            "default": "Face Parser (Full Face)",
            "parentSelection": "SwapModelSelection",
            "requiredSelectionValue": FLUX_SWAPPER_MODEL_NAME,
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Selects which mask generator the ACE++ swapper uses after the target person has already been chosen through Find Faces matching.",
        },
        "FluxMaskExpandSlider": {
            "level": 3,
            "label": "Mask Expand",
            "min_value": "0",
            "max_value": "40",
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Expand the full-face inpaint mask for the ACE++ swapper.",
        },
        "FluxMaskBlurSlider": {
            "level": 3,
            "label": "Mask Blur",
            ...
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Softens the edge of the full-face mask before FLUX inpainting.",
        },
        "FluxIncludeHairMaskToggle": {
            "level": 3,
            "label": "Include Hair In Mask",
            "default": False,
            "parentSelection": "SwapModelSelection",
            "requiredSelectionValue": FLUX_SWAPPER_MODEL_NAME,
            "parentToggle": "FluxSettingsEnableToggle",
            "requiredToggleValue": True,
            "help": "Optionally extend the ACE++ inpaint mask to include the hair region.",
        },
